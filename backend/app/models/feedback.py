...
class Feedback(db.Model):
    ...
    overall_detail = db.Column(db.Text, nullable=True)
    tutor_quality_rating = db.Column(db.Integer, nullable=True)
    tutor_quality_detail = db.Column(db.Text, nullable=True)
    ease_of_use_rating = db.Column(db.Integer, nullable=True)
    ease_of_use_detail = db.Column(db.Text, nullable=True)
    value_rating = db.Column(db.Integer, nullable=True)
    value_detail = db.Column(db.Text, nullable=True)
